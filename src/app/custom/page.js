...
export default function CrochetStudio() {
  ...
  const handleSubmit = (e) => {
    ...
    alert("Thank you! Your custom order request has been sent to the studio.");
    // Reset or redirect
  };
                ...
                {step === 4 && (
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        type="submit"
                        className="w-full btn-primary flex items-center justify-center gap-3 py-5 rounded-2xl shadow-lg border-0"
                      >
                        <Send size={18} />
                        Submit Custom Order
                      </button>
