  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-bottom duration-500">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-gray-400 font-medium">Save your favorite handcrafted items for later.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center min-h-[400px] flex flex-col items-center justify-center">
         ...
         <Link href="/shop" className="w-[200px] py-4 rounded-xl bg-[var(--color-primary)] text-white font-bold shadow-lg shadow-[var(--color-primary)]/20 hover:scale-[1.02] active:scale-95 transition-all mt-8">
            Explore Shop
          </Link>
      </div>
    </div>
