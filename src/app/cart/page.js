          ...
          <div className="flex flex-col lg:flex-row gap-8">
              ...
              {items.map((item) => (
                <div key={item.id} className="bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row gap-6 items-center">
                  <div className="relative w-24 h-24 sm:w-32 sm:h-32 flex-shrink-0 bg-gray-50 rounded-xl overflow-hidden">
                    <Image
                      src={item.images?.[0] || "https://images.unsplash.com/photo-1605338661642-cc019ba2f9ec?q=80&w=200"}
                      alt={item.name}
                      fill
            ...
            <div className="w-full lg:w-1/3">
              <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-gray-100 sticky top-24">
                ...
                <Link href="/checkout" className="btn-primary w-full flex items-center justify-center py-4 text-lg">
