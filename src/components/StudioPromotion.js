      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <p className="text-lg text-[var(--color-text-muted)] leading-relaxed mb-10 max-w-xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="relative aspect-[3/4] rounded-2xl overflow-hidden shadow-sm">
                  <Image src="https://images.unsplash.com/photo-1623910385973-7740eeb2e250?q=80&w=400" alt="Crochet process" fill className="object-cover" />
                </div>
                <div className="relative aspect-square rounded-2xl overflow-hidden shadow-sm">
                  <Image src="https://images.unsplash.com/photo-1563241527-300eceac2e19?q=80&w=400" alt="Colorful yarn" fill className="object-cover" />
                </div>
              </div>
              <div className="pt-12 space-y-4">
                <div className="relative aspect-[4/5] rounded-2xl overflow-hidden shadow-lg border-8 border-white">
                  <Image src="https://images.unsplash.com/photo-1605338661642-cc019ba2f9ec?q=80&w=400" alt="Finished custom gift" fill className="object-cover" />
                  <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/50 to-transparent p-6">
                    <p className="text-white text-xs font-medium italic">Hand-stitched for Ananya</p>
                  </div>
                </div>
              </div>
            </div>
