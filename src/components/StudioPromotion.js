      ...
      <div className="w-full relative z-10">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <motion.div variants={itemVariants} className="flex items-center justify-center lg:justify-start gap-2 mb-3 sm:mb-4">
            ...
            <motion.h2 variants={itemVariants} className="text-2xl md:text-4xl font-serif font-medium text-[var(--color-text-main)] mb-4 sm:mb-6 leading-tight">
              Design Your Own <br />
              <span className="text-[var(--color-primary)]">Custom Crochet</span>
            </motion.h2>

            <motion.p variants={itemVariants} className="text-sm sm:text-base text-[var(--color-text-muted)] leading-relaxed mb-6 sm:mb-8 max-w-lg mx-auto lg:mx-0 italic">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 items-center lg:items-start justify-center lg:justify-start">
            ...
            {/* Minimal Stat Icons */}
            <motion.div variants={containerVariants} className="grid grid-cols-3 gap-4 mt-6 sm:mt-8 pt-4 border-t border-gray-100 max-w-sm mx-auto lg:mx-0">
              <motion.div variants={itemVariants}>
                <p className="text-2xl font-serif font-medium text-[var(--color-text-main)]">15+</p>
                <p className="text-[9px] uppercase tracking-widest text-gray-400 font-bold">Colors</p>
              </motion.div>
              <motion.div variants={itemVariants}>
                <p className="text-2xl font-serif font-medium text-[var(--color-text-main)]">6</p>
                <p className="text-[9px] uppercase tracking-widest text-gray-400 font-bold">Base Types</p>
              </motion.div>
              <motion.div variants={itemVariants}>
                <p className="text-2xl font-serif font-medium text-[var(--color-text-main)]">0</p>
          ...
          <motion.div variants={itemVariants} className="w-full lg:w-1/2 relative max-w-xl mx-auto lg:mx-0">
            ...
            <motion.div 
              ...
              className="absolute -top-3 -right-2 bg-[var(--color-primary)] text-white p-3 sm:p-5 rounded-full w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center text-center leading-tight shadow-xl border-4 border-white z-20"
            >
